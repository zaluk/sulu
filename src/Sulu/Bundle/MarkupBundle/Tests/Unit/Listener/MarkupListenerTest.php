...
class MarkupListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->listener = new MarkupListener($this->markupParser->reveal());
    }

    public function testReplaceMarkup()
    {
        $this->responseHeaders->get('Content-Type')->willReturn('text/html');
    ...
    public function testReplaceMarkupPreview()
    {
        $this->responseHeaders->get('Content-Type')->willReturn(null);
        $this->request->get('preview')->willReturn(true);
