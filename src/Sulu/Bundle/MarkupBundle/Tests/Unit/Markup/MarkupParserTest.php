...
use Sulu\Bundle\MarkupBundle\Markup\MarkupParser;
...
class MarkupParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->tagRegistry->getTag('link')->willReturn($this->linkTag->reveal());
        $this->tagRegistry->getTag('media')->willReturn($this->mediaTag->reveal());
        $this->tagRegistry->getTag(Argument::any())->willThrow(new TagNotFoundException('test'));

        $this->parser = new MarkupParser($this->tagRegistry->reveal());
    }
